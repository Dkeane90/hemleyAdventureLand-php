...
<body>
    <!-- Header Image -->
    <img src="\adventureland\images\krazy_karts_title.png" alt="Attraction name Krazy Karts" class="header-image">
    ...
    <div class="container">
        <div class="text-container">
            <p><h2>This is the text that will be displayed to the left of the image. The text container is positioned 30 pixels higher than the image container.</h2></p>
        </div>
        <div class="image-container">
            <img src="\adventureland\images\krazy_karts1.jpg" alt="Go kart racing">
        </div>
    </div>
    <br>
    <br>
    ...
    <div class="container">
        ...
        <div class="image-container">
            <img src="\adventureland\images\krazy_karts2.jpg" alt="Go kart racing">
        </div>
    </div>
