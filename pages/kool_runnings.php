...
<body>
    <!-- Header Image -->
    <img src="\adventureland\images\kool_runnings_title.png" alt="Image displaying name of attraction Kool Runnings" class="header-image">
    ...
    <div class="container">
        ...
        <div class="image-container">
            <img src="\adventureland\images\kool_runnings2.jpg" alt="Kids enjoying waterslide">
        </div>
    </div>
    <br>
    <br>
    ...
    <div class="container">
        ...
        <div class="image-container">
            <img src="\adventureland\images\kool_runnings1.jpg" alt="Kids enjoying waterslide">
        </div>
    </div>
