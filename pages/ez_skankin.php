...
<body>
    <!-- Header Image -->
    <img src="\adventureland\images\EZ_skankin_title.png" alt="Attraction name EZ Skankin'" class="header-image">
    ...
    <div class="container">
        ...
        <div class="image-container">
            <img src="\adventureland\images\ez_skankin1.jpg" alt="Aerial shot people enjoying of pool and lazy river">
        </div>
    </div>
